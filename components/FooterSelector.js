        ...
        <div className="container">
          <div className="row">
            <div className="col-xs-6">
              <div className="row">
                <div className="col-xs-1">
                  <div className="footer-selector-type">TYPE</div>
                </div>
                <div className="col-xs-11 p-right-25">
                  <div className="row">
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="sedan"
                        icon="icon icon-footer__sedan"
                        href="/cheap-used-sedan-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="suv"
                        icon="icon icon-footer__suv"
                        href="/cheap-used-suv-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="convertible"
                        icon="icon icon-footer__convertible"
                        href="/cheap-used-convertible-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="coupe"
                        icon="icon icon-footer__coupe"
                        href="/cheap-used-coupe-for-sale"
                      />
                    </div>
                  </div>
                  <div className="row m-top-5">
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="hatchback"
                        icon="icon icon-footer__hatchback"
                        href="/cheap-used-hatchback-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="wagon"
                        icon="icon icon-footer__wagon"
                        href="/cheap-used-wagon-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="truck"
                        icon="icon icon-footer__truck_2"
                        href="/cheap-used-truck-for-sale"
                      />
                    </div>
                    <div className="col-xs-3">
                      <FooterSelectorTypeMake
                        title="bus"
                        icon="icon icon-footer__bus"
                        href="/cheap-used-bus-for-sale"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="row m-top-30">
                <div className="col-xs-1">
                  <div className="footer-selector-make">MAKE</div>
                </div>
                <div className="col-xs-11 p-right-25">
                  <div className="row">
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="toyota"
                        icon="icon icon-footer__toyota"
                        href="/cheap-used-toyota-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="nisan"
                        icon="icon icon-footer__nisan"
                        href="/cheap-used-nisan-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="honda"
                        icon="icon icon-footer__honda"
                        href="/cheap-used-honda-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="isuzu"
                        icon="icon icon-footer__isuzu"
                        href="/cheap-used-isuzu-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="bmw"
                        icon="icon icon-footer__bmw"
                        href="/cheap-used-bmw-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="volkswagen"
                        icon="icon icon-footer__volkswagen"
                        href="/cheap-used-volkswagen-for-sale"
                      />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="sabaru"
                        icon="icon icon-footer__sabaru"
                        href="/cheap-used-sabaru-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="mazda"
                        icon="icon icon-footer__mazda"
                        href="/cheap-used-mazda-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="suzuki"
                        icon="icon icon-footer__suzuki"
                        href="/cheap-used-suzuki-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="ford"
                        icon="icon icon-footer__ford"
                        href="/cheap-used-ford-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="mercedes_benz"
                        icon="icon icon-footer__mercedes_benz"
                        href="/cheap-used-mercedes_benz-for-sale"
                      />
                    </div>
                    <div className="col-xs-2">
                      <FooterSelectorTypeMake
                        title="volvo"
                        icon="icon icon-footer__volvo"
                        href="/cheap-used-volvo-for-sale"
                      />
                    </div>
                  </div>
                </div>
            ...
            <div className="col-xs-2">
              ...
              <FooterSelectorOptionLocal
                icon="icon icon-footer__mozambique"
                text="CFJ Mozambique"
                href="/cfj-mozambique"
              />
