  ...
  render() {
    return (
      <div className="corporate">
        ...
        <div className="text-title company">Company information</div>
        <div>
          <ul class="list-group">
            ...
            <li class="list-group-item">
              ...
              <div className="block-right text-left">ask@carfromjapan.com</div>
            </li>
            <li class="list-group-item">
              <div className="block-left text-left">Banks</div>
              <div className="block-right text-left">
                <div className="row-flex space-between">
                  <i className="icon icon-bank icon-about-us-bank__RESONA" />
                  <i className="icon icon-bank icon-about-us-bank__MIZUHO" />
                  <i className="icon icon-bank icon-about-us-bank__SUMITOMO_MITSUI" />
                </div>
              </div>
            </li>
          </ul>
        ...
        <div className="row mission row-flex center">
          <div className="col-xs-6">
            <div className="text-title">Why do we do this?</div>
            <p>
              The idea of CAR FROM JAPAN was born in 2014. At that time, there was so much of inconvenience in car
              export - import industry. Though buyers and sellers were getting connected online, the essential factors
              like trust, transparency, reliability and human connections were rare. Convenience and peace of mind in
              importing or exporting a car from japan was still a distant reality. Thus, Car From Japan was born to
              solve this problem.
            </p>
          </div>
          <div className="col-xs-6">
            <div className="cover" style={mission1BackgroundStyle} />
          </div>
        </div>
        <hr />
        <div className="row mission row-flex center">
          <div className="col-xs-6">
            <div className="cover" style={mission2BackgroundStyle} />
          </div>
          <div className="col-xs-6">
        ...
        <div className="row mission row-flex center">
          ...
          <div className="col-xs-6">
            <div className="cover" style={mission3BackgroundStyle} />
          </div>
        </div>

        <div className="coutries">
          <div className="bg-overlay" style={ContriesBackgroundStyle} />
          <div className="text-title text-center">We sell cars to these 69 countries</div>
          <hr />
          <div className="row">
