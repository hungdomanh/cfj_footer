    ...
    render() {
        return (
            <div className="contact-us">
                <h2 className="margin-xs strong-color"><b>Contact Us</b></h2>
                <hr/>
                ...
                <div className="send-message row">
                    ...
                    <div className="col-xs-12">
                        <textarea type="textarea" rows="4" class="form-control" placeholder="Message"></textarea>
                    </div>
                    <button className="btn btn-send" onClick={this.handleSend}>Send</button>
                </div>
            </div>
        )
    }
