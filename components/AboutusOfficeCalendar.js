    ...
    return (
      <div className="office-calendar">
        ...
        <div className="list-office">
          <div className="office row">
            <div className="col-xs-4">
              <div className="text-title">Japan Head Office (Tokyo)</div>
            </div>
            <div className="col-xs-8">
              ...
              <div className="row-flex row-info">
                ...
                <div>(EN) +81 3 4540 6692 / (JP) 03 4405 9092</div>
              </div>
              <div className="map">
                <div className="mapouter">
                  <div className="gmap_canvas">
                    <iframe
                      title="japan head office"
                      width="100%"
                      height="239"
                      id="gmap_canvas"
          ...
          <div className="office row">
            <div className="col-xs-4">
              <div className="text-title">Kenya Office</div>
            </div>
            <div className="col-xs-8">
              <div className="row-flex row-info">
                <i className="fa fa-map-marker-alt" />
          ...
          <div className="office row">
            <div className="col-xs-4">
              <div className="text-title">VietNam Office</div>
            </div>
            <div className="col-xs-8">
              <div className="row-flex row-info">
                <i className="fa fa-map-marker-alt" />
              ...
              <div className="row-flex row-info">
                <i className="fa fa-phone" />
                <div>+84 90 4500 489 / +84 90 4546 964</div>
              </div>
              <div className="map">
                <div className="mapouter">
                  <div className="gmap_canvas">
        ...
        <div className="calendar">
          <div className="text-title">Work Calendar of Japan Office</div>
